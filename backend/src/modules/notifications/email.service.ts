/**
 * @file Notifications: business operations and coordination with persistence or external services. File responsibility: email service.
...
/**
 * Send Otp Email.
 * @param toEmail To Email supplied to this operation (type: string).
 * @param otp Otp supplied to this operation (type: string).
 * @param purpose Purpose supplied to this operation (type: "SIGNUP" | "LOGIN").
 */
