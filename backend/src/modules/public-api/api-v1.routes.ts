/**
 * @file Public api: HTTP route registration and middleware order. File responsibility: api v1 routes.
 * Navigation and conventions: docs/code-navigation/README.md.
 */
import { Router } from "express";
import { authenticateApiV1, requireApiV1Scope } from "../authentication/public-api-authentication.middleware.js";
import { getPublicWebsiteHandler } from "../websites/website.controller.js";
import {
  listWebsitesHandler,
