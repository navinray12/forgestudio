/**
 * @file Integrations: business operations and coordination with persistence or external services. File responsibility: integration service.
...
/**
 * Is Private Ip.
 * @param address Address supplied to this operation (type: string).
 */
 ...
 * @param rawUrl Raw Url supplied to this operation (type: string).
 */
...
/**
 * Read Json Response.
 * @param response Response supplied to this operation (type: Response).
 */
...
/**
 * Validate Money.
 * @param amount Amount supplied to this operation (type: string).
...
export class IntegrationService {
   ...
   * @param amount Amount supplied to this operation (type: string).
   * @param currency Currency supplied to this operation (type: string). Defaults to "USD".
   * @param itemName Item Name supplied to this operation (type: string). Defaults to "Digital Product".
   * @param itemDescription Item Description supplied to this operation (type: string). Defaults to "".
   * @param quantity Quantity supplied to this operation (type: number). Defaults to 1.
   * @param env Env supplied to this operation (type: string). Defaults to "sandbox".
   */
   ...
   * @param orderId Order Id supplied to this operation (type: string).
   */
   ...
   * @param amount Amount supplied to this operation (type: string).
   * @param currency Currency supplied to this operation (type: string).
   * @param itemName Item Name supplied to this operation (type: string).
   */
  ...
  /**
   * Fetch Dynamic Data.
   * @param targetUrl Target Url supplied to this operation (type: string).
   * @param jsonPath Json Path supplied to this operation (type: string). Optional; callers may omit it.
   */
  ...
  /**
   * Submit Lead To CRM.
   * @param provider Provider supplied to this operation (type: string).
   * @param name Name supplied to this operation (type: string).
   * @param email Email address used by this operation.
   * @param customFields Custom Fields supplied to this operation (type: Record<string, unknown>). Optional; callers may omit it.
   */
  ...
  /**
   * Dispatch Webhook.
   * @param webhookUrl Webhook Url supplied to this operation (type: string).
   * @param eventType Event Type supplied to this operation (type: string).
   * @param payload Payload supplied to this operation (type: unknown). Optional; callers may omit it.
   * @param secret Secret supplied to this operation (type: string). Optional; callers may omit it.
   */
