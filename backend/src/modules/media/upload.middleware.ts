/**
 * @file Media: request processing before the final handler. File responsibility: upload middleware.
...
/**
 * Split Buffer.
 * @param buffer Buffer supplied to this operation (type: Buffer).
 * @param delimiter Delimiter supplied to this operation (type: Buffer).
 */
