...
} from "../authentication/mailer.controller.js";
import {
...
import {
  ...
  bulkSyncHandler,
  bulkDeleteHandler,
} from "../authentication/bulkOperations.controller.js";
import {
  runPerformanceAuditHandler,
  getPerformanceMetricsHandler,
} from "../authentication/performance.controller.js";
import {
  optimizeImageHandler,
  getOptimizationStatsHandler,
} from "../authentication/imageOptimization.controller.js";
import {
  getRemoteAdminOverviewHandler,
  generateWpAdminSsoHandler,
  optimizeRemoteDatabaseHandler,
} from "../authentication/wpAdmin.controller.js";
import {
  analyzeSeoHandler,
  auditImagesHandler,
...
} from "../authentication/seo.controller.js";
...
router.put("/:id/editor-data", authorizeCapability("EDIT"), updateWebsiteEditorDataHandler);
router.put("/:websiteId/editor-data", authorizeCapability("EDIT"), updateWebsiteEditorDataHandler);
