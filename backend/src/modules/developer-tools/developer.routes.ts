/**
 * @file Developer tools: HTTP route registration and middleware order. File responsibility: developer routes.
 * Navigation and conventions: docs/code-navigation/README.md.
 */
import { Router } from "express";
import crypto from "crypto";
import { requireApiScope } from "../authentication/api-key-authentication.middleware.js";
import {
