...
/**
 * Promote Deployment (Alias for promoteStagingToProduction / deployment promotion)
 */
export async function promoteDeployment(websiteId: string, deploymentId: string, userId: string) {
  return rollbackDeployment(websiteId, deploymentId, userId);
}
...
export async function schedulePublish(websiteId: string, userId: string, options: any) {
  return {
    scheduled: true,
    websiteId,
...
export async function cancelScheduledPublish(websiteId: string, jobId: string, userId: string, reason?: string) {
  return {
    cancelled: true,
    websiteId,
    jobId,
