/**
 * @file Publishing: module implementation. File responsibility: static compiler.
 * Navigation and conventions: docs/code-navigation/README.md.
 */
import type { StaticBundle, GeneratedFile } from "./types.js";
import { matchesThemeCondition, resolveTokensInTree } from "../../websites/website.service.js";
import {
 ...
 * @param allPages All Pages supplied to this operation (type: any[]).
 */
 ...
 * @param websiteData Website Data supplied to this operation (type: any).
 * @param allPages All Pages supplied to this operation (type: any[]).
 * @param compiledCss Compiled Css supplied to this operation (type: string).
 */
