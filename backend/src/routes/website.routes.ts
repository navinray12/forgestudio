...
router.get("/:id/wordpress/media", authorizeCapability("VIEW"), getWordPressMediaHandler);
router.get("/:id/wordpress/menus", authorizeCapability("VIEW"), getWordPressMenusHandler);
