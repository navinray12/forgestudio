...
export default function WebsiteEditor() {
  ...
  // Sync live editor state (elements & pageSettings) with the active page entry in pages array ONLY when in page mode
  useEffect(() => {
          ...
          return (
            ...
            >
              {wrappedImage ? (
                ...
                <div className="flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-slate-200 bg-slate-50 p-6 text-center shadow-inner">
                  <div className="text-3xl mb-1">🖼️</div>
                  <h4 className="text-xs font-bold text-slate-600">No Image Source</h4>
  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden bg-[#f1f5f9] text-slate-800 font-sans">
      ...
      {/* ========================================== */}
      {!isFullScreenCanvas && (
        <header className={`flex h-12 shrink-0 items-center justify-between px-5 shadow-md transition ${userPreferences.themeMode === "light"
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden lg:flex items-center gap-0.5 bg-slate-900/80 p-0.5 rounded-lg border border-slate-700/80 ml-1">
              <button
                ...
                className={`px-2 py-1 text-xs font-semibold rounded transition flex items-center gap-1 cursor-pointer ${canvasMode === "page"
              ...
              <button
                ...
                className={`px-2 py-1 text-xs font-semibold rounded transition flex items-center gap-1 cursor-pointer ${canvasMode === "header"
              ...
              <button
                ...
                className={`px-2 py-1 text-xs font-semibold rounded transition flex items-center gap-1 cursor-pointer ${canvasMode === "footer"
                  ? "bg-purple-600 text-white shadow-xs font-bold"
                  : "text-slate-400 hover:text-white"
                  }`}
          ...
          <div className="flex items-center gap-1 bg-[#16203a] p-1 rounded-lg border border-slate-700">
            {(["desktop", "tablet", "mobile"] as DeviceMode[]).map((mode) => (
              <button
                ...
                className={`px-3 py-1 text-xs font-semibold rounded-md capitalize transition flex items-center gap-1 ${activeDevice === mode
          ...
          <div className="flex items-center gap-2 overflow-x-auto no-scrollbar py-1">
            ...
            <div className="flex items-center gap-1.5 ml-1 shrink-0">
              <button
                ...
                className={`px-3 py-1 text-xs font-bold rounded-lg border transition cursor-pointer ${isPreview
              ...
              {/* F-PUBLISH: Website Publish & Deploy Trigger */}
              <button
                type="button"
