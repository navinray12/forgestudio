...
// ==========================================================
export const NavMenuRenderer: React.FC<NavigationRendererProps> = ({ element, activeBreakpointId, isPreview, pages, homePageId, onUpdateElement }) => {
            ...
            return (
              <div
                ...
                onDrop={(e) => {
                  ...
                  if (sourceIdxStr && onUpdateElement) {
                ...
                className={`relative group ${!isPreview ? "cursor-grab active:cursor-grabbing transition duration-150 hover:ring-1 hover:ring-blue-400 hover:ring-offset-1 rounded-lg" : ""}`}
