  ...
  switch (type) {
    ...
    case "share-buttons":
      return {
        ...
        shareUrl: "",
        shareText: "Check out this page!",
        shareHashtags: "ForgeStudio,WebsiteBuilder",
        ...
        shareButtonSize: "md",
        shareNetworks: [
          { id: "net_1", network: "facebook", label: "Share", urlSource: "inherit" },
          { id: "net_2", network: "twitter", label: "Tweet", urlSource: "inherit" },
          { id: "net_3", network: "linkedin", label: "Share", urlSource: "inherit" },
          { id: "net_4", network: "whatsapp", label: "WhatsApp", urlSource: "inherit" },
          { id: "net_5", network: "email", label: "Email", urlSource: "inherit" },
          { id: "net_6", network: "copy", label: "Copy Link", urlSource: "inherit" },
        ],
        styles: {
          width: "100%",
          marginTop: "12px",
    ...
    case "paypal-button":
      return {
        ...
        paypalItemDescription: "Instant access to digital downloads & platform features",
        paypalItemImage: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=600",
        paypalQuantity: 1,
        paypalEnv: "sandbox",
        paypalButtonStyle: "custom",
        paypalButtonShape: "pill",
        paypalLayout: "horizontal",
        ...
        paypalSuccessAction: "message",
        paypalSuccessMessage: "🎉 Payment received! Thank you for your order.",
        paypalSuccessRedirectUrl: "https://example.com/thank-you",
        paypalCancelMessage: "Payment was cancelled. You can retry whenever you are ready.",
        styles: {
          marginTop: "8px",
          marginBottom: "8px",
        },
    ...
    case "price-table":
      return {
        ...
        pricingColumns: 3,
        pricingGap: 24,
        pricingAlignment: "center",
        pricingCardBg: "#ffffff",
        pricingCardBorder: "#e2e8f0",
        pricingCardRadius: "16px",
        pricingHighlightColor: "#2563eb",
        pricingBtnBg: "#2563eb",
        pricingBtnColor: "#ffffff",
        pricingBtnHoverBg: "#1d4ed8",
        pricingBtnHoverColor: "#ffffff",
        pricingPlans: [
          {
            id: `plan_starter_${Date.now()}`,
            name: "Starter",
            price: "19",
            currency: "$",
            period: "/ month",
            description: "Essential tools for individuals & freelancers.",
            isPopular: false,
            isRecommended: false,
            badgeText: "BASIC",
            showBadge: false,
            ...
            features: [
              ...
              { id: "f3", text: "24/7 Community Support", included: true },
              { id: "f4", text: "Custom Domain Integration", included: false },
              { id: "f5", text: "Dedicated Account Manager", included: false },
            ],
          },
          {
            id: `plan_pro_${Date.now() + 1}`,
            name: "Professional",
            price: "49",
            currency: "$",
            period: "/ month",
            description: "Powerful features for growing teams & startups.",
            isPopular: true,
            isRecommended: true,
            badgeText: "MOST POPULAR",
            showBadge: true,
            ...
            features: [
              { id: "f1", text: "Unlimited Projects", included: true },
              { id: "f2", text: "Advanced Analytics & Reports", included: true },
              { id: "f3", text: "Priority Email & Chat Support", included: true },
              { id: "f4", text: "Custom Domain Integration", included: true },
              { id: "f5", text: "Dedicated Account Manager", included: false },
            ],
          },
          {
            id: `plan_enterprise_${Date.now() + 2}`,
            name: "Enterprise",
            price: "99",
            currency: "$",
            period: "/ month",
            ...
            buttonWidth: "full",
            features: [
              { id: "f1", text: "Unlimited Projects & Workspaces", included: true },
              { id: "f2", text: "Custom BI Analytics & Exports", included: true },
              { id: "f3", text: "24/7 Phone & Dedicated Manager", included: true },
              { id: "f4", text: "Custom Domain & SSL Certificates", included: true },
              { id: "f5", text: "Custom SLA & Security Audit", included: true },
            ],
          },
        ],
        styles: {
