...
import { resolveWidget } from "../../../editor/core/registry/widgetRuntime";

/**
 * resolveCanvasWidgetDefinition
 * Phase 5 Registry Integration Point:
 * Queries WidgetRuntime (WidgetRegistry) first for widget definition metadata,
 * ensuring registry lookup succeeds with seamless fallback to existing renderers.
 */
export function resolveCanvasWidgetDefinition(type: ElementType | string) {
  const definition = resolveWidget(type);
  if (definition) {
    return definition;
  }
  return undefined;
