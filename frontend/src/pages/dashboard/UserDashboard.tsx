...
function UserDashboard() {
  ...
  const handleImportDashboardKit = async (kitData: {
    ...
    try {
      ...
      navigate(`/websites/${newSiteId}/edit`);
    } catch (err) {
  ...
  const handleCreateSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setIsModalOpen(false); setWebsiteName(""); navigate(`/websites/${data.website.id}/edit`);
  ...
  function WebsitesTab() {
    return (
      <div className="space-y-6">
        ...
        {currentTeamId ? (
          <TeamDashboardView teamId={currentTeamId} apiUrl={apiUrl} onNavigateEditor={id => navigate(`/websites/${id}/edit`)} />
        ) : (
          <div>
                    ...
                    >
                      ...
                      <div className="mt-6 flex items-center justify-between border-t border-slate-100 pt-4">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            onClick={() => navigate(`/websites/${site.id}/edit`)}
